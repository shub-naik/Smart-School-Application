...
public class AddSubject extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        final androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(AddSubject.this);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                TeacherDataAdapter adapter = new TeacherDataAdapter(AddSubject.this, R.layout.allteachersdata, AllTeachers);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(AddSubject.this, "Database Error ....", Toast.LENGTH_SHORT).show();
                alertDialog.dismiss();
            }
        });
    }
    ...
    private void showUpdateDialog(final String phone) {
        ...
        Update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.dismiss();
                Toast.makeText(AddSubject.this, "Teacher Data With Phone " + phone + " is Updated.", Toast.LENGTH_SHORT).show();
            }
        });
