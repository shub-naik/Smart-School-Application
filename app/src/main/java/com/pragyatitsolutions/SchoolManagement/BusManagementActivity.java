...
public class BusManagementActivity extends AppCompatActivity {
    ...
    CardView addDriverCardView, deleteDriverCardView, viewDriverCardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewDriverCardView = findViewById(R.id.ViewDriverCardView);
        ...
        viewDriverCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ViewDriverFragment fragment = new ViewDriverFragment();
                getSupportFragmentManager().beginTransaction().replace(R.id.BusManagementFrameContainer, fragment).commit();
            }
        });
    }
